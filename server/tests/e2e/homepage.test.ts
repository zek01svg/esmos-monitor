...
test.describe('Homepage', () => {
  ...
  test('main content should have complete elements', async ({ page }) => {
    // hero section
    await expect(page.locator('h1')).toContainText('Healthy Eating Made Easy');
  ...
  test('footer should have complete elements', async ({ page }) => {
    ...
    await expect(page.getByText('About us Everyday Sustainable')).toBeVisible();
